...
var Behance = function () {
  ...
  _createClass(Behance, [{
    ...
    key: 'project',
    value: function project(id) {
      return this.request('/projects/' + id);
    }
  }, {
    key: 'projectComments',
    value: function projectComments(id) {
    ...
    key: 'userProjects',
    value: function userProjects(id, params) {
      return this.request('/users/' + id + '/projects', params);
    }
  }, {
    key: 'userWips',
    value: function userWips(id, params) {
      return this.request('/users/' + id + '/wips', params);
    }
  }, {
    key: 'userApprecitations',
    value: function userApprecitations(id, params) {
      return this.request('/users/' + id + '/appreciations', params);
    }
  }, {
    key: 'userCollections',
    value: function userCollections(id, params) {
      return this.request('/users/' + id + '/collections', params);
    }
  }, {
    key: 'userStats',
    value: function userStats(id) {
      return this.request('/users/' + id + '/stats');
    }
  }, {
    key: 'userFollowers',
    value: function userFollowers(id, params) {
      return this.request('/users/' + id + '/followers', params);
    }
  }, {
    key: 'userFollowing',
    value: function userFollowing(id, params) {
      return this.request('/users/' + id + '/following', params);
    }
  }, {
    key: 'userWorkExperience',
    value: function userWorkExperience(id) {
    ...
    key: 'teamProjects',
    value: function teamProjects(id, params) {
    ...
    key: 'collectionProjects',
    value: function collectionProjects(id, params) {
    ...
    value: function request(uri) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        parameters.client_id = _this.apiKey;
        var url = '' + _this.baseEndpoint + uri + '?' + parameterize(params).join('&');
        (0, _jsonp2.default)(url, null, function (error, data) {
          if (error) {
